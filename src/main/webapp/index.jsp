...
<body>
  ...
  <!--UserName And Password-->
			<p><label for="username" id="username"><i class="fas fa-id-card" style="color: black;"></i> Username:</label></p> 
			<p> <input
				type="text" name="usernameinput" id="usernameinput"
				placeholder="Enter the username" pattern="[a-zA-Z0-9]{8,20}"
				title="username must be in 8 character" required></p>
			
			<p><label for="password"><i class="fas fa-lock" style="color: black;"></i> Password:</label> <br> <input
				type="password" name="passwordinput" id="passwordinput"
				placeholder="Enter the password"
				pattern="[a-zA-Z0-9!@#$%^&*()]{8,20}"
				title="password must be in 8 character" required></p>
